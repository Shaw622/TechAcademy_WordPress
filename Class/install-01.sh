...
echo "WordPressのフォルダ権限を変更...開始"
WP_OWNER=ec2-user # &lt;-- wordpress owner
WP_GROUP=ec2-user # &lt;-- wordpress echo 
WP_ROOT=/home/ec2-user/environment/WordPress # &lt;-- wordpress root directory
...
echo "WordPressのフォルダ権限を変更...完了"


echo "PHP7.2のインストール...開始"
